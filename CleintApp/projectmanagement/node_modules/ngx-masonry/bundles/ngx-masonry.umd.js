    ...
    ***************************************************************************** */
    ...
    var NgxMasonryComponent = /** @class */ (function () {
        function NgxMasonryComponent(platformId, _element) {
            ...
            this.itemsLoaded = new core.EventEmitter();
            this.pendingItems = [];
        }
        ...
        NgxMasonryComponent.prototype.addPendingItem = function (item) {
            this.pendingItems.push(item);
        };
        NgxMasonryComponent.prototype.add = function (newItem) {
            var e_1, _a;
            if (this.ordered) {
                try {
                    for (var _b = __values(this.pendingItems.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
        ...
        NgxMasonryComponent.prototype.itemLoaded = function (item) {
            if (common.isPlatformBrowser(this.platformId)) {
    ...
    NgxMasonryComponent.propDecorators = {
        ...
        ordered: [{ type: core.Input }],
        layoutComplete: [{ type: core.Output }],
        removeComplete: [{ type: core.Output }],
        itemsLoaded: [{ type: core.Output }]
    };

    var NgxMasonryDirective = /** @class */ (function () {
        function NgxMasonryDirective(element, builder, parent, renderer) {
            ...
            this.animations = {
                ...
                hide: [
                    animations.style({ opacity: '*' }),
                    animations.animate('400ms ease-in', animations.style({ opacity: 0 })),
                ]
            };
        }
